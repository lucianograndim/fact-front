  ...
  <div class="cont">
    ...
    <v-container class="justify-center" pa-8>
      ...
      <v-card-title class="justify-center py-7">
        <div style="flex: auto; text-align-last: center">Formulario empresa</div>
      </v-card-title>
      <v-container class="py-4">
        <v-row>
          <v-col class="" >
            <v-container style="height: fit-content">
              <p class="text-center font-weight-medium" style="font-size: 20px;">
                Asociarme a una empresa
              </p>
              <v-container class="py-6 px-4">
                <v-text-field label="Número identificador de la empresa"></v-text-field>
                <v-text-field label="Nombre de la empresa"></v-text-field>
              </v-container>
              <v-container class="d-flex justify-center">
                <v-btn
                  @click="setrole('client-role')"
                  depressed
                  color="#06b7b2"
                  class="white--text"	
                >
          ...
          <v-col>
            ...
            <v-container class="py-6 px-4">
              <v-text-field label="Nombre de la empresa"></v-text-field>
              <v-text-field label="Número de identificación"></v-text-field>
              <v-text-field label="Dirección de la empresa"></v-text-field>
              <v-textarea label="Descripción de la empresa"></v-textarea>
            </v-container>
            <v-container class="d-flex justify-center">
              <v-btn
                @click="setrole('client-role')"
