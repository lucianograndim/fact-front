...
@Component({
    name: 'AlloxentricSidebar'
    })
    
  
	export default class AlloxentricSidebar {
		public selected = 0;
		private currentRoute = '';
		public items: Array<INavigator> = [
				{
					title: 'Solicitudes' as string,
					urlName: 'Inicio',
					parent: 'dashboardInicio',
					subMenus: [],
				},
				{ /* se creo otra opcion para el menu */
					title: 'Usuarios Alloxentric' as string,
					urlName: 'Usuarios',
					parent: 'dashboardInicio',
					subMenus: [],
				},
        {
          title: 'Usuarios Cliente' as string,
          urlName: 'AlloxentricClient',
          parent: 'dashboardInicio',
          subMenus: [],
        },
        {
          title: 'Usuarios Agentes' as string,
          urlName: 'AlloxentricAgent',
          parent: 'dashboardInicio',
          subMenus: [],
        },
		]
